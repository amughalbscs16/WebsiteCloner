...
g.Kc=function(a,b){g.Ca(a);void 0===b&&(b=0);Ic();for(var c=Jc[b],d=[],e=0;e<a.length;e+=3){var f=a[e],k=e+1<a.length,l=k?a[e+1]:0,m=e+2<a.length,p=m?a[e+2]:0,t=f>>2;f=(f&3)<<4|l>>4;l=(l&15)<<2|p>>6;p&=63;m||(p=64,k||(l=64));d.push(c[t],c[f],c[l]||"",c[p]||"")}return d.join("")};
...
g.Lc=function(a,b){function c(m){for(;d<a.length;){var p=a.charAt(d++),t=Mc[p];if(null!=t)return t;if(!g.ob(p))throw Error("Unknown base64 encoding at char: "+p);}return m}
...
g.pd=function(a,b,c){return g.nd(document,arguments)};
...
g.zd=function(a){var b=[];g.xd(a,function(c){b.push(c)});
return b};
...
g.Cd=function(a,b){g.Ad(a,g.w(g.Bd,b))};
g.Ad=function(a,b){a.Qc?b():(a.xf||(a.xf=[]),a.xf.push(b))};
g.Bd=function(a){a&&"function"==typeof a.dispose&&a.dispose()};
g.Dd=function(){this.C=function(a){return void 0===a?!1:a};
this.F=function(a){return void 0===a?0:a}};
g.Ed=function(a,b,c,d){this.left=a;this.top=b;this.width=c;this.height=d};
g.Fd=function(a,b){"number"==typeof a&&(a=(b?Math.round(a):a)+"px");return a};
g.Gd=function(a,b){a.style.width=g.Fd(b,!0)};
...
g.Ld=function(a,b){try{return(void 0===b?0:b)?(new g.fd(a.innerWidth,a.innerHeight)).round():g.ld(a).round()}catch(c){return new g.fd(-12245933,-12245933)}};
...
saa=function(){function a(){e[0]=1732584193;e[1]=4023233417;e[2]=2562383102;e[3]=271733878;e[4]=3285377520;t=p=0}
function b(y){for(var z=k,D=0;64>D;D+=4)z[D/4]=y[D]<<24|y[D+1]<<16|y[D+2]<<8|y[D+3];for(D=16;80>D;D++)y=z[D-3]^z[D-8]^z[D-14]^z[D-16],z[D]=(y<<1|y>>>31)&4294967295;y=e[0];var O=e[1],T=e[2],ra=e[3],Ba=e[4];for(D=0;80>D;D++){if(40>D)if(20>D){var Ia=ra^O&(T^ra);var yd=1518500249}else Ia=O^T^ra,yd=1859775393;else 60>D?(Ia=O&T|ra&(O|T),yd=2400959708):(Ia=O^T^ra,yd=3395469782);Ia=((y<<5|y>>>27)&4294967295)+Ia+Ba+yd+z[D]&4294967295;Ba=ra;ra=T;T=(O<<30|O>>>2)&4294967295;O=y;y=Ia}e[0]=e[0]+y&4294967295;e[1]=
e[1]+O&4294967295;e[2]=e[2]+T&4294967295;e[3]=e[3]+ra&4294967295;e[4]=e[4]+Ba&4294967295}
function c(y,z){if("string"===typeof y){y=unescape(encodeURIComponent(y));for(var D=[],O=0,T=y.length;O<T;++O)D.push(y.charCodeAt(O));y=D}z||(z=y.length);D=0;if(0==p)for(;D+64<z;)b(y.slice(D,D+64)),D+=64,t+=64;for(;D<z;)if(f[p++]=y[D++],t++,64==p)for(p=0,b(f);D+64<z;)b(y.slice(D,D+64)),D+=64,t+=64}
function d(){var y=[],z=8*t;56>p?c(l,56-p):c(l,64-(p-56));for(var D=63;56<=D;D--)f[D]=z&255,z>>>=8;b(f);for(D=z=0;5>D;D++)for(var O=24;0<=O;O-=8)y[z++]=e[D]>>O&255;return y}
for(var e=[],f=[],k=[],l=[128],m=1;64>m;++m)l[m]=0;var p,t;a();return{reset:a,update:c,digest:d,Fu:function(){for(var y=d(),z="",D=0;D<y.length;D++)z+="0123456789ABCDEF".charAt(Math.floor(y[D]/16))+"0123456789ABCDEF".charAt(y[D]%16);return z}}};
taa=function(a,b,c){var d=[],e=[];if(1==(g.Aa(c)?2:1))return e=[b,a],(0,g.B)(d,function(l){e.push(l)}),Od(e.join(" "));
...
a=Od(e.join(" "));a=[c,a];g.Na(k)||a.push(k.join(""));return a.join("_")};
Od=function(a){var b=saa();b.update(a);return b.Fu().toLowerCase()};
g.Pd=function(a){var b=Nd(String(g.q.location.href)),c;(c=g.q.__SAPISID||g.q.__APISID||g.q.__OVERRIDE_SID)?c=!0:(c=new g.Wc(document),c=c.get("SAPISID")||c.get("APISID")||c.get("__Secure-3PAPISID")||c.get("SID"),c=!!c);if(c&&(c=(b=0==b.indexOf("https:")||0==b.indexOf("chrome-extension:"))?g.q.__SAPISID:g.q.__APISID,c||(c=new g.Wc(document),c=c.get(b?"SAPISID":"APISID")||c.get("__Secure-3PAPISID")),c)){b=b?"SAPISIDHASH":"APISIDHASH";var d=String(g.q.location.href);return d&&c&&b?[b,taa(Nd(d),c,a||
null)].join(" "):null}return null};
Qd=function(){this.C=[];this.F=-1};
uaa=function(a){-1==a.F&&(a.F=(0,g.Rd)(a.C,function(b,c,d){return c?b+Math.pow(2,d):b},0));
return a.F};
g.Sd=function(){var a=new Qd;g.q.SVGElement&&g.q.document.createElementNS&&a.set(0);var b=raa();b["allow-top-navigation-by-user-activation"]&&a.set(1);b["allow-popups-to-escape-sandbox"]&&a.set(2);g.q.crypto&&g.q.crypto.subtle&&a.set(3);g.q.TextDecoder&&g.q.TextEncoder&&a.set(4);return uaa(a)};
g.Td=function(a){return{visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[a.visibilityState||a.webkitVisibilityState||a.mozVisibilityState||""]||0};
...
g.He=function(a,b){this.C=0;this.N=void 0;this.G=this.F=this.D=null;this.H=this.L=!1;if(a!=g.xa)try{var c=this;a.call(b,function(d){g.Ge(c,2,d)},function(d){g.Ge(c,3,d)})}catch(d){g.Ge(this,3,d)}};
...
g.Ne=function(a){return new g.He(function(b,c){var d=a.length,e=[];if(d)for(var f=function(p,t){d--;e[p]=t;0==d&&b(e)},k=function(p){c(p)},l=0,m;l<a.length;l++)m=a[l],g.Me(m,g.w(f,l),k);
else b(e)})};
...
g.Ge=function(a,b,c){0==a.C&&(a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself")),a.C=1,Le(c,a.Y,a.M,a)||(a.N=c,a.C=b,a.D=null,Te(a),3!=b||c instanceof g.Ve||Caa(a,c)))};
...
af=function(){this.F=64;this.C=[];this.L=[];this.N=[];this.G=[];this.G[0]=128;for(var a=1;a<this.F;++a)this.G[a]=0;this.H=this.D=0;this.reset()};
bf=function(a,b,c){c||(c=0);var d=a.N;if("string"===typeof b)for(var e=0;16>e;e++)d[e]=b.charCodeAt(c)<<24|b.charCodeAt(c+1)<<16|b.charCodeAt(c+2)<<8|b.charCodeAt(c+3),c+=4;else for(e=0;16>e;e++)d[e]=b[c]<<24|b[c+1]<<16|b[c+2]<<8|b[c+3],c+=4;for(e=16;80>e;e++){var f=d[e-3]^d[e-8]^d[e-14]^d[e-16];d[e]=(f<<1|f>>>31)&4294967295}b=a.C[0];c=a.C[1];var k=a.C[2],l=a.C[3],m=a.C[4];for(e=0;80>e;e++){if(40>e)if(20>e){f=l^c&(k^l);var p=1518500249}else f=c^k^l,p=1859775393;else 60>e?(f=c&k|l&(c|k),p=2400959708):
...
g.wg=function(){g.cg(g.og);g.cg(g.qg);g.qg=0;rg&&rg.isReady()?(sg(g.tg),"log_event"in ug&&sg(Object.entries(ug.log_event)),g.tg.clear(),delete ug.log_event):g.vg()};
g.vg=function(){g.Sf("web_gel_timeout_cap")&&!g.qg&&(g.qg=g.ag(g.wg,6E4));g.cg(g.og);var a=g.Tf("web_gel_debounce_ms",1E4);a=g.F("LOGGING_BATCH_TIMEOUT",g.xg||a);g.Sf("shorten_initial_gel_batch_timeout")&&yg&&(a=Raa);g.og=g.ag(g.wg,a)};
...
g.Rg=function(){if(g.Sf("use_typescript_transport"))g.wg();else if(g.cg(g.Gg),g.cg(g.Hg),g.Hg=0,!g.Wa(g.Ig)){for(var a in g.Ig){var b=Jg[a];if(b&&b.isReady()){var c=void 0,d=a,e=Uaa[d],f=Math.round((0,g.zg)());for(c in g.Ig[d]){var k=g.ab(g.Ag(b));k[e]=Kg(d,c);var l=Lg[c];if(l)a:{var m=k,p=c;if(l.videoId)var t="VIDEO";else if(l.playlistId)t="PLAYLIST";else break a;m.credentialTransferTokenTargetId=l;m.context=m.context||{};m.context.user=m.context.user||{};m.context.user.credentialTransferTokens=
[{token:p,scope:t}]}delete Lg[c];l=k;l.requestTimeMs=f;g.Sf("unsplit_gel_payloads_in_logs")&&(l.unsplitGelPayloadsInLogs=!0);if(t=g.F("EVENT_ID",void 0))m=g.F("BATCH_CLIENT_COUNTER",void 0)||0,!m&&g.Sf("web_client_counter_random_seed")&&(m=Math.floor(Math.random()*Mg/2)),m++,m>Mg&&(m=1),g.Of("BATCH_CLIENT_COUNTER",m),t={serializedEventId:t,clientCounter:m},l.serializedClientEventId=t,Ng&&Og&&g.Sf("log_gel_rtt_web")&&(l.previousBatchInfo={serializedClientEventId:Ng,roundtripMs:Og}),Ng=t,Og=0;g.Cg(b,
...
g.hh=function(a){this.Pb=a;this.C=null;this.D=0;this.L=null;this.G=0;this.F=[];for(a=0;4>a;a++)this.F.push(0);this.H=0;this.J=g.I(window,"mousemove",(0,g.v)(this.Y,this));this.M=g.bg((0,g.v)(this.N,this),25)};
$aa=function(){};
...
g.ph=function(){null==g.u("_lact",window)&&g.rh();var a=(0,g.ad)();g.r("_lact",a,window);-1==g.u("_fact",window)&&g.r("_fact",a,window);(a=g.u("ytglobal.ytUtilActivityCallback_"))&&a()};
...
g.Kh=function(a){var b={};b.dt=g.Nh;b.flash="0";a:{try{var c=a.C.top.location.href}catch(d){a=2;break a}a=c?c===a.F.location.href?0:1:2}b=(b.frm=a,b);g.Kd(b);return b};
g.Lh=function(a){var b=g.Md(a.C),c=g.Ld(a.C.top),d={};return d.bc=g.Sd(),d.bih=c.height,d.biw=c.width,d.brdim=b.join(),d.vis=g.Td(a.F),d.wgl=!!g.Id.WebGLRenderingContext,d};
...
g.J=function(a,b){var c=b.format||"JSON";a=Th(a,b);var d=Uh(a,b),e=!1,f,k=Vh(a,function(l){if(!e){e=!0;f&&g.cg(f);var m=g.Qh(l),p=null,t=400<=l.status&&500>l.status,y=500<=l.status&&600>l.status;if(m||t||y)p=fba(c,l,b.ob);if(m)a:if(l&&204==l.status)m=!0;else{switch(c){case "XML":m=0==parseInt(p&&p.return_code,10);break a;case "RAW":m=!0;break a}m=!!p}p=p||{};t=b.context||g.q;m?b.onSuccess&&b.onSuccess.call(t,l,p):b.onError&&b.onError.call(t,l,p);b.Xa&&b.Xa.call(t,l,p)}},b.method,d,b.headers,b.responseType,
b.withCredentials);
...
ci=function(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||g.F("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.lR||g.F("AUTHORIZATION"))||(a?b="Bearer "+g.u("gapi.auth.getToken")().jR:b=g.Pd([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=g.F("SESSION_INDEX",0),g.Sf("pageid_as_header_web")&&(d["X-Goog-PageId"]=g.F("DELEGATED_SESSION_ID")));return d};
di=function(a){a=Object.assign({},a);delete a.Authorization;var b=g.Pd();if(b){var c=new af;c.update(g.F("INNERTUBE_API_KEY",void 0));c.update(b);a.hash=g.Kc(c.digest(),3)}return a};
...
timeout:d.timeout,withCredentials:!0},f="",k=a.C.wy;k&&(f=k);k=a.C.xy||!1;var l=ci(k,f,d);Object.assign(e.headers,l);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var m=g.Gh(""+f+("/youtubei/"+a.C.innertubeApiVersion+"/"+b),{alt:"json",key:a.C.innertubeApiKey}),p;if(d.retry&&g.Sf("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(p=hba(b,c,l,k))){var t=e.onSuccess,y=e.cj;e.onSuccess=function(z,D){ki(p);t(z,D)};
...
window.console.log(d,a)),0!==a.C)){d=a.F;e=a.columnNumber;if(a.args&&a.args.length)for(var k=0,l=0;l<a.args.length;l++){f=a.args[l];var m="params."+l;k+=m.length;if(f)if(Array.isArray(f))for(var p=c,t=0;t<f.length&&!(f[t]&&(k+=si(t,f[t],m,p),500<k));t++);else if("object"===typeof f)for(p in p=void 0,t=c,f){if(f[p]&&(k+=si(p,f[p],m,t),500<k))break}else c[m]=String(JSON.stringify(f)).substring(0,500),k+=c[m].length;else c[m]=String(JSON.stringify(f)).substring(0,500),k+=c[m].length;if(500<=k)break}else if(a.hasOwnProperty("params"))if(f=
...
g.bj=function(a,b,c){var d=Ui();if(!d)return 0;var e=d.subscribe(a.toString(),function(f,k){var l=g.u("ytPubsub2Pubsub2SkipSubKey");l&&l==e||(l=function(){if(Wi[e])try{if(k&&a instanceof g.Ti&&a!=f)try{var m=a.C,p=k;if(!p.args||!p.version)throw Error("yt.pubsub2.Data.deserialize(): serializedData is incomplete.");try{if(!m.Ie){var t=new m;m.Ie=t.version}var y=m.Ie}catch(z){}if(!y||p.version!=y)throw Error("yt.pubsub2.Data.deserialize(): serializedData version is incompatible.");try{k=Reflect.construct(m,
...
Wi[e]=!0;aj[a.toString()]||(aj[a.toString()]=[]);aj[a.toString()].push(e);return e};
oba=function(){var a=mba,b=g.bj(nba,function(c){a.apply(void 0,arguments);g.cj(b)},void 0);
return b};
g.cj=function(a){var b=Ui();b&&("number"===typeof a&&(a=[a]),(0,g.B)(a,function(c){b.unsubscribeByKey(c);delete Wi[c]}))};
...
a,g.mi);g.r("_fact",-1,window);lj++;g.kj=(0,g.zg)()}};
...
g.wj=function(a,b,c,d,e){e=void 0===e?"":e;a&&(c&&(c=g.Pb,c=!(c&&0<=c.toLowerCase().indexOf("cobalt"))),c?a&&(a=g.Db(g.Hb(a)),"about:invalid#zClosurez"===a?a="":(a=g.Zb(g.ac(a)),a=g.ec(g.of(a))),g.ob(a)||(a=g.pd("IFRAME",{src:'javascript:"<body><img src=\\""+'+a+'+"\\"></body>"',style:"display:none"}),g.vd(a).body.appendChild(a))):e?Vh(a,b,"POST",e,d):g.F("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)||d?Vh(a,b,"GET","",d):pba(a,b)||qba(a,b))};
...
Mj=function(a,b,c,d){g.C.call(this);var e=this;this.L=this.Ya=a;this.ha=b;this.N=!1;this.api={};this.na=this.M=null;this.Y=new g.rf;g.Cd(this,this.Y);this.G={};this.la=this.qa=this.F=this.nb=this.C=null;this.T=!1;this.H=this.J=null;this.ib={};this.Pd=["onReady"];this.kb=null;this.sb=NaN;this.W={};this.D=d;Jj(this);this.Lh("WATCH_LATER_VIDEO_ADDED",this.wD.bind(this));this.Lh("WATCH_LATER_VIDEO_REMOVED",this.xD.bind(this));this.Lh("onAdAnnounce",this.Nt.bind(this));this.Hb=new Bi(this);g.Cd(this,this.Hb);
...
tba=function(a){Jj(a);a.N=!0;var b=Oj(a);b.addEventListener&&(a.M=Uj(a,b,"addEventListener"));b.removeEventListener&&(a.na=Uj(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.api[e]||(a.api[e]=Uj(a,b,e))}for(var f in a.G)a.M(f,a.G[f]);Nj(a);a.qa&&a.qa(a.api);a.Y.oa("onReady",a.api)};
...
Jj=function(a){a.N=!1;if(a.na)for(var b in a.G)a.na(b,a.G[b]);for(var c in a.W)g.cg(parseInt(c,10));a.W={};a.M=null;a.na=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.Lh.bind(a);a.api.removeEventListener=a.fG.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.Av.bind(a);a.api.getPlayerType=a.Gv.bind(a);a.api.getCurrentVideoConfig=a.wv.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.rz.bind(a)};
...
nk=function(a){g.r("ytglobal.timingready_",a,void 0)};
ok=function(a){return!!g.u("yt.timing."+(a||"")+"pingSent_")};
pk=function(a,b){g.r("yt.timing."+(b||"")+"pingSent_",a,void 0)};
...
qk=function(a){var b={tick:{},info:{}};g.r("ytcsi."+(a||"")+"data_",b,void 0);return b};
...
wk=function(){var a=g.u("ytcsi.debug");a||(a=[],g.r("ytcsi.debug",a,void 0),g.r("ytcsi.reference",{},void 0));return a};
...
Kk=function(a){qk(a);Cba();pk(!1,a);a||(g.F("TIMING_ACTION")&&g.Of("PREVIOUS_ACTION",g.F("TIMING_ACTION")),g.Of("TIMING_ACTION",""))};
Nk=function(a,b,c){Lk("yt_sts",a,c);g.Mk("_start",b,c)};
Lk=function(a,b,c){null!==b&&(sk(c)[a]=b,Dk(c)?(a=Ik(a,b,c))&&Dk(c)&&(b=yk(c||""),Cj(b.info,a),Cj(Jk(c),a),c=tk(c),Ak().info(a,c)):yk(c||"").info[a]=b)};
g.Mk=function(a,b,c){var d=hk(c);if(g.Sf("use_first_tick")&&Pk(a,c))return d[a];b||"_"===a[0]||Qk(a,c);var e=b||(0,g.zg)();d[a]=e;Fk(a,b,c)||(g.Rk(!1,c),yk(c||"").tick[a]=b||(0,g.zg)());return d[a]};
Sk=function(a,b,c){if(Dk(c)){var d=Ek(c);if(d.gelSpans)d.gelSpans[a]=!0;else{var e={};d.gelSpans=(e[a]=!0,e)}a={spanName:a,spanLengthUsec:String(Math.round(1E3*b))};yk(c||"").span[String(a.spanName)]=a;b=Ek(c);"gelSpans"in b||(b.gelSpans={});Cj(b.gelSpans,a);c=tk(c);Ak().span(a,c)}};
Qk=function(a,b){jk.mark&&(g.mb(a,"mark_")||(a="mark_"+a),b&&(a+=" ("+b+")"),jk.mark(a))};
Pk=function(a,b){var c=hk(b);return a in c};
g.Rk=function(a,b){if(!ok(b)){var c=g.F((b||"")+"TIMING_ACTION",void 0),d=hk(b);if(g.u("ytglobal.timing"+(b||"")+"ready_")&&c&&Pk("_start")&&ik(b))if(vk(b),a||b)Tk(b);else{c=!0;var e=g.F("TIMING_WAIT",[]);if(e.length)for(var f=0,k=e.length;f<k;++f)if(!(e[f]in d)){c=!1;break}c&&Tk(b)}}};
...
Tk=function(a){if(!Dk(a)){var b=hk(a),c=sk(a),d=b._start,e=g.F("CSI_SERVICE_NAME","youtube"),f={v:2,s:e,action:g.F((a||"")+"TIMING_ACTION",void 0)},k=c.srt;void 0!==b.srt&&delete c.srt;b.aft=ik(a);var l=hk(a),m=l.pbr,p=l.vc;l=l.pbs;m&&p&&l&&m<p&&p<l&&sk(a).yt_pvis&&"youtube"===e&&(Lk("yt_lt","hot_bg",a),e=b.vc,m=b.pbs,delete b.aft,c.aft=Math.round(m-e));for(var t in c)"_"!==t.charAt(0)&&(f[t]=c[t]);b.ps=(0,g.zg)();t={};e=[];for(var y in b)"_"!==y.charAt(0)&&(m=Math.round(b[y]-d),t[y]=m,e.push(y+"."+
m));f.rt=e.join(",");b=!!c.ap;g.Sf("debug_csi_data")&&(c=g.u("yt.timing.csiData"),c||(c=[],g.r("yt.timing.csiData",c,void 0)),c.push({page:location.href,time:new Date,args:f}));c="";for(var z in f)f.hasOwnProperty(z)&&(c+="&"+z+"="+f[z]);f="/csi_204?"+c.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var D=void 0===D?"":D;xj(f,D)||g.wj(f,void 0,void 0,void 0,D)}else g.wj(f);pk(!0,a);g.Vi(Eba,new gk(t.aft+(Number(k)||0),a))}};
Uk=function(a,b){if(!Dk(b)&&!ok(b)){var c=g.F("CSI_SERVICE_NAME","youtube");g.F((b||"")+"TIMING_ACTION",void 0)&&c&&(g.Mk("aa",void 0,b),Lk("ap",1,b),Lk("yt_fss",a,b),Tk(b))}};
Fba=function(a,b){var c=document.querySelector(a);if(!c)return!1;var d="",e=c.nodeName;"SCRIPT"===e?(d=c.src,d||(d=c.getAttribute("data-timing-href"))&&(d=window.location.protocol+d)):"LINK"===e&&(d=c.href);g.wa()&&c.setAttribute("nonce",g.wa());return d?(c=jk.getEntriesByName(d))&&c[0]&&(c=c[0],d=mk(),g.Mk("rsf_"+b,d+Math.round(c.fetchStart)),g.Mk("rse_"+b,d+Math.round(c.responseEnd)),void 0!==c.transferSize&&(d=sk(void 0),e=Jk(void 0),"rc"in d||"rc"in e||Lk("rc",""),0===c.transferSize))?!0:!1:!1};
Vk=function(a){if(!g.Sf("log_deltas_killswitch")){var b,c,d,e;if(jk&&jk.timing){jk.timeOrigin&&jk.timing.navigationStart&&Sk("startTimeDelta",jk.timeOrigin-jk.timing.navigationStart,a);var f=null===(e=null===(d=null===(c=null===(b=jk.getEntriesByType)||void 0===b?void 0:b.call(jk,"navigation"))||void 0===c?void 0:c[0])||void 0===d?void 0:d.toJSON)||void 0===e?void 0:e.call(d);f&&f.responseEnd&&jk.timing.responseEnd&&Sk("responseEndDelta",f.responseEnd-jk.timing.responseEnd,a)}}b=lk();b.isPerformanceNavigationTiming&&
Lk("pnt",1,a);g.Mk("nreqs",b.requestStart,a);g.Mk("nress",b.responseStart,a);g.Mk("nrese",b.responseEnd,a);0<b.redirectEnd-b.redirectStart&&(g.Mk("nrs",b.redirectStart,a),g.Mk("nre",b.redirectEnd,a));0<b.domainLookupEnd-b.domainLookupStart&&(g.Mk("ndnss",b.domainLookupStart,a),g.Mk("ndnse",b.domainLookupEnd,a));0<b.connectEnd-b.connectStart&&(g.Mk("ntcps",b.connectStart,a),g.Mk("ntcpe",b.connectEnd,a));b.secureConnectionStart>=mk()&&0<b.connectEnd-b.secureConnectionStart&&(g.Mk("nstcps",b.secureConnectionStart,
a),g.Mk("ntcpe",b.connectEnd,a))};
Gba=function(){var a=window.location.protocol,b=jk.getEntriesByType("resource");b=(0,g.Wk)(b,function(c){return 0===c.name.indexOf(a+"//fonts.gstatic.com/s/")});
(b=(0,g.Rd)(b,function(c,d){return d.duration>c.duration?d:c},{duration:0}))&&0<b.startTime&&0<b.responseEnd&&(g.Mk("wffs",kk(b.startTime)),g.Mk("wffe",kk(b.responseEnd)))};
Hba=function(){var a=g.F("TIMING_ACTION",void 0),b=g.F("TIMING_AFT_KEYS");yk("").info.actionType=a;b&&g.Of("TIMING_AFT_KEYS",b);g.Of("TIMING_ACTION",a);a=g.F("TIMING_INFO",{});for(var c in a)a.hasOwnProperty(c)&&Lk(c,a[c]);Lk("is_nav",1);(c=g.Pi())&&Lk("csn",c);(c=g.F("PREVIOUS_ACTION",void 0))&&!Dk()&&Lk("pa",c);c=sk();a=g.F("CLIENT_PROTOCOL");b=g.F("CLIENT_TRANSPORT");a&&Lk("p",a);b&&Lk("t",b);Lk("yt_vis",Dba());if("cold"===c.yt_lt){Lk("yt_lt","cold");a=lk();if(b=mk())g.Mk("srt",a.responseStart),
1!==c.prerender&&Nk("n",b);c=zba();0<c&&g.Mk("fpt",c);Vk();jk&&jk.getEntriesByType&&Gba();c=[];if(document.querySelector&&jk&&jk.getEntriesByName)for(var d in Xk)Xk.hasOwnProperty(d)&&(a=Xk[d],Fba(d,a)&&c.push(a));c.length&&Lk("rc",c.join(","))}Dk(void 0)&&(d={actionType:Yk[g.F("TIMING_ACTION",void 0)]||"LATENCY_ACTION_UNKNOWN",previousAction:Yk[g.F("PREVIOUS_ACTION",void 0)]||"LATENCY_ACTION_UNKNOWN"},c=tk(void 0),Ak().info(d,c));d=sk();a=hk();if("cold"===d.yt_lt&&(c=Ek(),b=c.gelTicks?c.gelTicks:
c.gelTicks={},c=c.gelInfos?c.gelInfos:c.gelInfos={},Dk())){for(var e in a)"tick_"+e in b||Fk(e,a[e]);e=Jk();a=tk();b={};for(var f in d)if(!("info_"+f in c)){var k=Ik(f,d[f]);k&&(Cj(e,k),Cj(b,k))}Ak().info(b,a)}nk(!0);g.Rk(!1)};
Nba=function(){Zk++;var a=g.ld(),b=new g.Ed(0,0,a.width,a.height);Lk("vph",a.height,void 0);Lk("vpw",a.width,void 0);g.Mk("vpc",void 0,void 0);a=document.querySelectorAll(".yt-lockup-thumbnail img[data-ytimg]");var c=a.length,d=[];$k.start();for(var e=0;e<c;e++){var f=a[e];al(f,b)&&(f=Iba(f),f.then(Jba),d.push(f),bl.push(f))}g.Mk("vpcc",void 0,void 0);b=g.Ne(d).then(Kba);g.Pe(b,Lba);b.then(Mba);bl.push(b);return b};
Mba=function(){$k.stop()};
Lba=function(){g.Mk("vpr",void 0,void 0)};
...
Kba=function(a){var b=g.ld();b=new g.Ed(0,0,b.width,b.height);for(var c=0,d=0,e=a.length;d<e;d++){var f=a[d].time;al(a[d].py,b)&&c<f&&(c=f)}return c};
...
Jba=function(a){$k.start();a=a.time;fl<a&&(fl=a,g.Mk("lim",a,void 0))};
Oba=function(){g.Mk("vptl",fl,void 0);g.Mk("vpl",fl,void 0)};
...
ml=function(a){for(var b in g.Xj){var c=g.Xj[b];c&&c.cancel()}if(a=a||null)g.Yj("player-api",a),a=g.Di(a),a.loaded=!0;kl();g.r("ytplayer.config",a,void 0)};
...
ol=function(){g.Mk("ol",void 0,void 0);window.requestAnimationFrame&&!document.hidden?window.requestAnimationFrame(function(){setTimeout(function(){g.Mk("cpt",void 0,void 0);g.H("on_cpt_tick",(new Date).getTime())},0)}):document.hidden?(g.Mk("cpt",void 0,void 0),g.H("on_cpt_tick",(new Date).getTime())):setTimeout(function(){g.Mk("cpt",void 0,void 0);
g.H("on_cpt_tick",(new Date).getTime())},0);
Sba();g.F("CSI_VIEWPORT")&&(nl=Nba(),nl.then(function(a){g.Mk("vpl",a,void 0);nl=null},function(){}))};
...
Tba=function(){ol()};
Uba=function(){g.F("TIMING_REPORT_ON_UNLOAD")&&g.Rk(!0,void 0);Uk("u",void 0);g.mj("FOREGROUND_HEARTBEAT_TRIGGER_ON_BACKGROUND");ij();g.Rg();rl();g.kg("pageunload")};
sl=function(){g.ph()};
tl=function(){window.yt_spf_loaded_history=!0;g.ph()};
yl=function(){ul=1;vl=wl=0;g.F("TIMING_REPORT_ON_UNLOAD")&&g.Rk(!0,void 0);if(g.Sf("warm_load_nav_start_web")){var a=xk();a[""]&&delete a[""];var b={timerName:"",info:{},tick:{},span:{}};wk().push(b);a[""]=b;Uk("n");Kk();nk(!1);g.Of("TIMING_AFT_KEYS",[]);Lk("yt_lt","warm");g.Of("TIMING_ACTION","");g.Of("TIMING_WAIT",[]);delete g.F("TIMING_INFO",{}).yt_lt;Nk("n")}else Uk("n",void 0),Kk(void 0),Nk("n",void 0,void 0);Qk("nr",void 0);xl(Vba);ij();g.kg("navigate")};
Cl=function(a){a=a.detail.part||a.detail.partial;g.Mk("nc"+wl,void 0,void 0);++wl;if(a&&a.data&&a.data.deferDispose)"watch"==a.name&&g.Mk("bc",void 0,void 0);else{var b=1==ul;ul=2;b?(xl(Wba),zl()):xl(Xba);if(b=a&&a.data&&a.data.swfcfg)Al(a.timing,b.args),Bl(b)}};
Dl=function(){g.Mk("np"+vl,void 0,void 0);++vl};
El=function(a){a=a.detail.response;var b=1==ul;ul=3;b&&(xl(Yba),zl());if(b=a.data&&a.data.swfcfg)Al(a.timing,b.args),Bl(b)};
Il=function(a){g.Mk("nd",void 0,void 0);a=a.detail.response;g.Fl=a.cacheKey;a=a.timing;var b=window._spf_state;g.Gl.navigationCount=b&&b["nav-counter"]||0;g.Sf("warm_load_nav_start_web")?g.Mk("srt",a.responseStart,void 0):(Nk("ne",a.responseStart,void 0),b=lk().responseStart,Lk("srt",Math.max(0,b-mk()),void 0));Lk("yt_lt",a.spfCached?"hot":"warm",void 0);g.Mk("pfs",a.fetchStart,void 0);g.Mk("pfrs",a.responseStart,void 0);"redirectStart"in a&&Vk(void 0);xl(Hl);document.getElementById("content").style.height=
"";ol();ul=0};
...
kca=function(){var a=g.A("yt-push-prompt-modal-bg");Tl=g.Sf("service_worker_push_prompt_modal_ignore_click");a?Ul(a):(a=g.pd("div",{id:"yt-push-prompt-modal-bg"}),Ul(a),document.body.appendChild(a),g.fh(document,"click",lca))};
...
if("function"==typeof Object.setPrototypeOf)Yl=Object.setPrototypeOf;else{var Zl;a:{var rca={a:!0},$l={};try{$l.__proto__=rca;Zl=$l.a;break a}catch(a){}Zl=!1}Yl=Zl?function(a,b){a.__proto__=b;if(a.__proto__!==b)throw new TypeError(a+" is not extensible");return a}:null}var ha=Yl,ia=aaa(this),ja="function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){if(a==Array.prototype||a==Object.prototype)return a;
...
b.prototype.H=function(){function k(p){return function(t){m||(m=!0,p.call(l,t))}}
...
b.prototype.then=function(k,l){function m(z,D){return"function"==typeof z?function(O){try{p(z(O))}catch(T){t(T)}}:D}
var p,t,y=new b(function(z,D){p=z;t=D});
this.Sh(m(k,p),m(l,t));return y};
...
b.race=function(k){return new b(function(l,m){for(var p=g.da(k),t=p.next();!t.done;t=p.next())d(t.value).Sh(l,m)})};
b.all=function(k){var l=g.da(k),m=l.next();return m.done?d([]):new b(function(p,t){function y(O){return function(T){z[O]=T;D--;0==D&&p(z)}}
var z=[],D=0;do z.push(void 0),D++,d(m.value).Sh(y(z.length-1),t),m=l.next();while(!m.done)})};
return b});
...
function f(m){var p=Object[m];p&&(Object[m]=function(t){if(t instanceof c)return t;e(t);return p(t)})}
if(function(){if(!a||!Object.seal)return!1;try{var m=Object.seal({}),p=Object.seal({}),t=new a([[m,2],[p,3]]);if(2!=t.get(m)||3!=t.get(p))return!1;t["delete"](m);t.set(p,4);return!t.has(m)&&4==t.get(p)}catch(y){return!1}}())return a;
...
e.prototype.forEach=function(l,m){for(var p=this.entries(),t;!(t=p.next()).done;)t=t.value,l.call(m,t[1],t[0],this)};
...
return e};
g.Rd=Array.prototype.reduce?function(a,b,c,d){d&&(b=(0,g.v)(b,d));return Array.prototype.reduce.call(a,b,c)}:function(a,b,c,d){var e=c;
...
return!0};var bb="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");g.fb.prototype.Md=!0;g.fb.prototype.Tc=function(){return this.C};
var eb={},db={};g.vca=RegExp("[A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0900-\u1fff\u200e\u2c00-\ud801\ud804-\ud839\ud83c-\udbff\uf900-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]");g.wca=RegExp("^[^\u0591-\u06ef\u06fa-\u08ff\u200f\ud802-\ud803\ud83a-\ud83b\ufb1d-\ufdff\ufe70-\ufefc]*[A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0900-\u1fff\u200e\u2c00-\ud801\ud804-\ud839\ud83c-\udbff\uf900-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]");g.em=RegExp("^[^A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0900-\u1fff\u200e\u2c00-\ud801\ud804-\ud839\ud83c-\udbff\uf900-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]*[\u0591-\u06ef\u06fa-\u08ff\u200f\ud802-\ud803\ud83a-\ud83b\ufb1d-\ufdff\ufe70-\ufefc]");g.kb.prototype.Md=!0;g.kb.prototype.Tc=function(){return this.F.toString()};
...
g.Oc.prototype.clone=function(){return new this.constructor(Rc(this.Yc()))};g.Em=document;g.Id=window;var Vc={};g.h=g.Wc.prototype;g.h.isEnabled=function(){return navigator.cookieEnabled};
...
g.h.round=function(){this.width=Math.round(this.width);this.height=Math.round(this.height);return this};var id={cellpadding:"cellPadding",cellspacing:"cellSpacing",colspan:"colSpan",frameborder:"frameBorder",height:"height",maxlength:"maxLength",nonce:"nonce",role:"role",rowspan:"rowSpan",type:"type",usemap:"useMap",valign:"vAlign",width:"width"};var Ica={ZJ:"allow-forms",aK:"allow-modals",bK:"allow-orientation-lock",cK:"allow-pointer-lock",dK:"allow-popups",eK:"allow-popups-to-escape-sandbox",fK:"allow-presentation",gK:"allow-same-origin",hK:"allow-scripts",iK:"allow-top-navigation",jK:"allow-top-navigation-by-user-activation"},qaa=g.Sa(function(){return g.zd(Ica)});g.C.prototype.Qc=!1;g.C.prototype.pb=function(){return this.Qc};
...
*/
g.ya(g.Dd);g.h=g.Ed.prototype;g.h.clone=function(){return new g.Ed(this.left,this.top,this.width,this.height)};
...
g.He.prototype.M=function(a){this.C=0;g.Ge(this,3,a)};
g.He.prototype.J=function(){for(var a;a=Re(this);)Se(this,a,this.C,this.N);this.L=!1};
...
return d};g.Nf=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};g.r("yt.config_",g.Nf,void 0);var Xf={};var Maa=[];var Mca=g.u("ytPubsubPubsubInstance")||new g.rf;g.rf.prototype.subscribe=g.rf.prototype.subscribe;g.rf.prototype.unsubscribeByKey=g.rf.prototype.od;g.rf.prototype.publish=g.rf.prototype.oa;g.rf.prototype.clear=g.rf.prototype.clear;g.r("ytPubsubPubsubInstance",Mca,void 0);var fg=g.u("ytPubsubPubsubSubscribedKeys")||{};g.r("ytPubsubPubsubSubscribedKeys",fg,void 0);var hg=g.u("ytPubsubPubsubTopicToKeys")||{};g.r("ytPubsubPubsubTopicToKeys",hg,void 0);var gg=g.u("ytPubsubPubsubIsSynchronous")||{};
g.r("ytPubsubPubsubIsSynchronous",gg,void 0);var Paa=/\.vflset|-vfl[a-zA-Z0-9_+=-]+/,Qaa=/-[a-zA-Z]{2,3}_[a-zA-Z]{2,3}(?=(\/|$))/;var Pm;Pm=window;g.zg=Pm.ytcsi&&Pm.ytcsi.now?Pm.ytcsi.now:Pm.performance&&Pm.performance.timing&&Pm.performance.now&&Pm.performance.timing.navigationStart?function(){return Pm.performance.timing.navigationStart+Pm.performance.now()}:function(){return(new Date).getTime()};var Raa,Eg,Fg,Dg,rg,yg,ug;Raa=g.Tf("initial_gel_batch_timeout",1E3);Eg=Math.pow(2,16)-1;g.yh=10;Fg=null;Dg=0;rg=void 0;g.og=0;g.qg=0;g.xh=0;yg=!0;ug=g.u("ytLoggingTransportLogPayloadsQueue_")||{};g.r("ytLoggingTransportLogPayloadsQueue_",ug,void 0);g.tg=g.u("ytLoggingTransportGELQueue_")||new Map;g.r("ytLoggingTransportGELQueue_",g.tg,void 0);var Bg=g.u("ytLoggingTransportTokensToCttTargetIds_")||{};g.r("ytLoggingTransportTokensToCttTargetIds_",Bg,void 0);var Xaa,Mg,Ng,Og,Uaa,Vaa,Jg,Pg;Xaa=g.Tf("initial_gel_batch_timeout",1E3);Mg=Math.pow(2,16)-1;g.Ah=10;Ng=null;Og=0;Uaa={log_event:"events",log_interaction:"interactions"};Vaa=new Set(["log_event"]);Jg={};g.Gg=0;g.Hg=0;g.zh=0;Pg=!0;g.Ig=g.u("ytLoggingTransportLogPayloadsQueue_")||{};g.r("ytLoggingTransportLogPayloadsQueue_",g.Ig,void 0);var Lg=g.u("ytLoggingTransportTokensToCttTargetIds_")||{};g.r("ytLoggingTransportTokensToCttTargetIds_",Lg,void 0);var Nca=0,Yaa=g.qm?"webkit":g.pm?"moz":g.Ef?"ms":g.mm?"o":"",Tg=g.u("ytDomDomGetNextId")||function(){return++Nca};
g.r("ytDomDomGetNextId",Tg,void 0);var Zaa={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};g.Xg.prototype.preventDefault=function(){this.event&&(this.event.returnValue=!1,this.event.preventDefault&&this.event.preventDefault())};
...
g.Xg.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var ah=g.u("ytEventsEventsListeners")||{};g.r("ytEventsEventsListeners",ah,void 0);var ch=g.u("ytEventsEventsCounter")||{count:0};g.r("ytEventsEventsCounter",ch,void 0);var dh=g.Sa(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
...
g.hh.prototype.N=function(){if(this.C){var a=g.Qm();if(0!=this.D){var b=g.ed(this.L,this.C)/(a-this.D);this.F[this.H]=.5<Math.abs((b-this.G)/this.G)?1:0;for(var c=0,d=0;4>d;d++)c+=this.F[d]||0;3<=c&&this.Pb();this.G=b}this.D=a;this.L=this.C;this.H=(this.H+1)%4}};
g.hh.prototype.X=function(){g.dg(this.M);g.eh(this.J)};g.n(nh,$aa);nh.prototype.start=function(){var a=g.u("yt.scheduler.instance.start");a&&a()};
nh.prototype.pause=function(){var a=g.u("yt.scheduler.instance.pause");a&&a()};
g.ya(nh);nh.getInstance();var uh={};var wh=g.u("ytLoggingGelSequenceIdObj_")||{};g.r("ytLoggingGelSequenceIdObj_",wh,void 0);g.Jh=new function(){var a=window.document;this.C=window;this.F=a};
g.r("yt.ads_.signals_.getAdSignalsString",function(a){return g.Dh(Mh(a))},void 0);(0,g.ad)();var Oh=void 0!==XMLHttpRequest?function(){return new XMLHttpRequest}:void 0!==ActiveXObject?function(){return new ActiveXObject("Microsoft.XMLHTTP")}:null;var Rh,cba,Wh;Rh={Authorization:"AUTHORIZATION","X-Goog-Visitor-Id":"SANDBOXED_VISITOR_ID","X-YouTube-Client-Name":"INNERTUBE_CONTEXT_CLIENT_NAME","X-YouTube-Client-Version":"INNERTUBE_CONTEXT_CLIENT_VERSION","X-YouTube-Device":"DEVICE","X-Youtube-Identity-Token":"ID_TOKEN","X-YouTube-Page-CL":"PAGE_CL","X-YouTube-Page-Label":"PAGE_BUILD_LABEL","X-YouTube-Variants-Checksum":"VARIANTS_CHECKSUM"};cba="app debugcss debugjs expflag force_ad_params force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address".split(" ");
...
Bi.prototype.X=function(){for(;this.C.length;){var a=this.C.pop();a.target.removeEventListener(a.name,a.callback)}g.C.prototype.X.call(this)};Ci.prototype.clone=function(){var a=new Ci,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==g.za(c)?a[b]=g.$a(c):a[b]=c}return a};var Ei=(0,g.ad)().toString();var Gi=g.u("ytLoggingDocDocumentNonce_")||Fi();g.r("ytLoggingDocDocumentNonce_",Gi,void 0);g.Ii.prototype.toString=function(){return JSON.stringify(g.Ji(this))};g.r("yt_logging_screen.getRootVeType",Mi,void 0);g.r("yt_logging_screen.getCurrentCsn",g.Pi,void 0);g.r("yt_logging_screen.getCttAuthInfo",g.Qi,void 0);g.r("yt_logging_screen.setCurrentScreen",g.Ri,void 0);g.Ti.prototype.toString=function(){return this.topic};var Oca=g.u("ytPubsub2Pubsub2Instance")||new g.rf;g.rf.prototype.subscribe=g.rf.prototype.subscribe;g.rf.prototype.unsubscribeByKey=g.rf.prototype.od;g.rf.prototype.publish=g.rf.prototype.oa;g.rf.prototype.clear=g.rf.prototype.clear;g.r("ytPubsub2Pubsub2Instance",Oca,void 0);var Wi=g.u("ytPubsub2Pubsub2SubscribedKeys")||{};g.r("ytPubsub2Pubsub2SubscribedKeys",Wi,void 0);var aj=g.u("ytPubsub2Pubsub2TopicToKeys")||{};g.r("ytPubsub2Pubsub2TopicToKeys",aj,void 0);
var $i=g.u("ytPubsub2Pubsub2IsAsync")||{};g.r("ytPubsub2Pubsub2IsAsync",$i,void 0);g.r("ytPubsub2Pubsub2SkipSubKey",null,void 0);g.n(dj,g.Si);var nba=new g.Ti("screen-created",dj),ej=[],fj=0;var lj,jj;lj=0;g.kj=null;jj=null;g.h=g.nj.prototype;g.h.qG=function(){this.Nd()||this.init()};
...
g.h.clear=function(){g.jg(this.G);this.G=[]};var pj=g.u("yt.modules.registry_")||{};g.r("yt.modules.registry_",pj,void 0);g.sj=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};g.r("yt.msgs_",g.sj,void 0);var yj={},rba=0;var sba=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;g.n(Mj,g.C);g.h=Mj.prototype;g.h.getId=function(){return this.ha};
g.h.loadNewVideoConfig=function(a){if(!this.pb()){this.aa&&(g.cg(this.aa),this.aa=0);this.nb=a=g.Di(a);this.C=a.clone();Kj(this);this.qa||(this.qa=Vj(this,this.C.args.jsapicallback||"onYouTubePlayerReady"));this.C.args.jsapicallback=null;(a=this.C.attrs.width)&&g.Gd(this.L,Number(a)||a);if(a=this.C.attrs.height)this.L.style.height=g.Fd(Number(a)||a,!0);Lj(this);this.N&&Nj(this)}};
g.h.wv=function(){return this.nb};
g.h.rz=function(){return this.N};
g.h.Lh=function(a,b){var c=this,d=Vj(this,b);if(d){if(!g.Ma(this.Pd,a)&&!this.G[a]){var e=uba(this,a);this.M&&this.M(a,e)}this.Y.subscribe(a,d);"onReady"==a&&this.N&&g.ag(function(){d(c.api)},0)}};
...
Cba=(0,g.v)(jk.clearResourceTimings||jk.webkitClearResourceTimings||jk.mozClearResourceTimings||jk.msClearResourceTimings||jk.oClearResourceTimings||g.xa,jk);var Bk=g.u("ytLoggingLatencyUsageStats_")||{};g.r("ytLoggingLatencyUsageStats_",Bk,void 0);zk.prototype.tick=function(a,b,c){Ck(this,"tick_"+a+"_"+b)||g.ni("latencyActionTicked",{tickName:a,clientActionNonce:b},{timestamp:c})};
...
Xm={},Hk=(Xm.ccs="CANARY_STATE_",Xm.mver="MEASUREMENT_VERSION_",Xm.pis="PLAYER_INITIALIZED_STATE_",Xm.yt_pt="LATENCY_PLAYER_",Xm.pa="LATENCY_ACTION_",Xm.yt_vst="VIDEO_STREAM_TYPE_",Xm),Bba="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");if(g.Sf("overwrite_polyfill_on_logging_lib_loaded")){var Ym=window;Ym.ytcsi&&(Ym.ytcsi.info=Lk,Ym.ytcsi.tick=g.Mk)};var fl=0,bl=[],el=[],Zk=0,cl={},dl={},$k=new g.$e(Oba,1E3);var hl=["server_prefetched_vast","vmap"];var jl;var nl=null,ql=[];var ul,Ml,Ll,wl,vl,Vba,Yba,Wba,Xba,Hl;wl=0;vl=0;Vba=[900,60,"waiting"];Yba=[500,99,"waiting"];Wba=[300,60,"waiting"];Xba=[400,99,"waiting"];Hl=[300,101,"done"];var Tl=!1;window.yt=window.yt||{};g.r("yt.setConfig",g.Of,void 0);g.r("yt.pushConfigArray",Pf,void 0);g.r("yt.getConfig",g.F,void 0);g.r("yt.config.set",g.Of,void 0);g.r("yt.config.pushArray",Pf,void 0);g.r("yt.config.get",g.F,void 0);g.r("yt.hasMsg",g.uj,void 0);g.r("yt.setMsg",tj,void 0);g.r("yt.setGoogMsg",vj,void 0);g.r("yt.msgs.has",g.uj,void 0);g.r("yt.msgs.set",tj,void 0);g.r("yt.msgs.setGoog",vj,void 0);g.r("yt.pubsub.publish",g.H,void 0);g.r("yt.pubsub.subscribe",g.ig,void 0);
g.r("ytcsi.tick",function(a,b,c){return g.Mk(a,b,c)},void 0);
g.x(Wl,g.nj);
...
g.r("yt.abuse.player.botguardInitialized",jba,void 0);g.r("yt.abuse.player.invokeBotguard",kba,void 0);g.r("yt.abuse.dclkstatus.checkDclkStatus",iba,void 0);g.r("yt.player.exports.navigate",g.Ij,void 0);g.r("yt.util.activity.init",g.rh,void 0);g.r("yt.util.activity.getTimeSinceActive",g.vh,void 0);g.r("yt.util.activity.setTimestamp",g.ph,void 0);ml(g.u("ytplayer.config"));g.u("ytspf.enabled")&&Rba();Hba();g.F("SERVICE_WORKER_KILLSWITCH",void 0)||navigator.serviceWorker&&navigator.serviceWorker.getRegistrations&&
