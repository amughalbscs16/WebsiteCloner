...
<html lang="en">
  ...
  <meta name="request-id" content="60F2:46A9:AB9E7:152B1F:5EAD71BE" data-pjax-transient="true"/><meta name="html-safe-nonce" content="0f4f5e4a27beaf4bcfa4283e8278ec5178afff27" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6IiIsInJlcXVlc3RfaWQiOiI2MEYyOjQ2QTk6QUI5RTc6MTUyQjFGOjVFQUQ3MUJFIiwidmlzaXRvcl9pZCI6IjU4MDM2ODc3NDk4NzY1NDM5MzUiLCJyZWdpb25fZWRnZSI6ImlhZCIsInJlZ2lvbl9yZW5kZXIiOiJpYWQifQ==" data-pjax-transient="true"/><meta name="visitor-hmac" content="9a369d052f972fd842951188cb52f3aee9ba8115009b20e8dce49c460ef77577" data-pjax-transient="true"/>
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
  ...
  <meta http-equiv="x-pjax-version" content="49d35ffb67c545c9d805aff8029b7521">
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" role="search" aria-label="Site" data-unscoped-search-url="/search" action="/search" accept-charset="UTF-8" method="get">
      <label class="form-control input-sm header-search-wrapper p-0 header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          autocomplete="off"
          >
          <input type="hidden" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" value="JORdmuEGFJ19NHbHjdnr6rJGB5TXIPxh7r7ImNJjU3sROsZ26vj519e+hrhF315WgP1eUCPdmuIgB6/s/yISBQ==" />
...
<div class="py-6 py-sm-8 jumbotron-codelines">
  <div class="p-responsive position-relative container-lg">
    <div class="d-md-flex flex-items-center gutter-md-spacious">
      <div class="col-md-7 text-center text-md-left ">
        ...
        <p class="lead-mktg mb-4">
          GitHub is a development platform inspired by the way you work. From <a href="/open-source" class="text-white jumbotron-link">open source</a> to <a href="/business" class="text-white jumbotron-link">business</a>, you can host and review code, manage projects, and build software alongside 50 million developers.
        </p>
      </div>
        <div class="mx-auto col-sm-8 col-md-6 hide-sm">
  <div class="rounded-1 text-gray bg-gray-light py-4 px-4 px-md-3 px-lg-4">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="home-hero-signup text-gray-dark js-signup-form js-signup-form-submit" autocomplete="off" action="/join" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="xVcsbhgVqP20q3OAfZop6F0AWLhl/aRIwrKH2vTPrkKe214o8Gcnwsq0yVRT1WVmti5lGN6me+kogVR5aFS5fg==" />      <input type="hidden" name="ga_id" class="js-octo-ga-id-input">
      <auto-check src="/signup_check/username?source=homepage&amp;suggest_usernames=true">
        ...
        <input type="hidden" data-csrf="true" value="q30zEF3ocCvBPlACGk6ecEzVwFyY54F1+kLzlqxBGDcuwX8+KH5GHcfJDgvVvxz6hfam4+gvEodfL/wSoqDgrw==" />
      </auto-check>
      <auto-check src="/signup_check/email">
        ...
        <input type="hidden" data-csrf="true" value="7MIjERGVxfrbO3dLTZmACbtWJmd2nbAEzh9kYFFhNXE53ZbuzEpPURqG+uJLzWhrEW4xRD7aNuksxDIRm1EbKg==" />
      </auto-check>
      <password-strength
      ...
      <input class="form-control" type="text" name="required_field_16f4" hidden="hidden" />
<input class="form-control" type="hidden" name="timestamp" value="1588425151407" />
<input class="form-control" type="hidden" name="timestamp_secret" value="8cf6e5b7bfc1463ba1c19ac4d5529d51f8190fd1f82a03431e8e9e72280954c9" />

      <button type="submit" class="btn-mktg btn-primary-mktg btn-large-mktg f4 btn-block my-3" data-ga-click="Signup, Attempt, location:home hero">Sign up for GitHub</button>
  ...
  <div class="container-xl p-responsive py-5 py-md-6 py-lg-7">
    
<div class="bg-blue-7 text-white rounded-2 box-shadow-large mx-md-2 position-relative promo-banner-bg">
  <div class="position-relative d-lg-flex flex-justify-between px-4 px-md-6 py-4 py-md-5 gutter-md-spacious z-2">
    <div class="col-lg-9 d-lg-flex">
      <div class="mt-0 mr-0 mt-md-1 mr-md-3 mb-2 mb-md-0">
        <span title="NEW" class="Label Label--outline Label--outline-green">NEW</span>
      </div>
      <div>
        <h2 class="mb-1 lh-condensed lh-md-default">
          GitHub is now free for teams
        </h2>
        <p class="mb-3 mb-lg-0 f4">
    ...
    <p class="col-lg-3 mb-0 flex-md-self-center">
        <a class="btn-mktg btn-block h4-mktg" data-ga-click="Home banner, click, text:Try GitHub free; ref_page:Home" href="/join?plan=free&amp;source=pricing-card-free">Try GitHub Free</a>
    </p>
  </div>
</div>
...
<div class="container-lg p-responsive">
  <div class="text-center py-5 py-md-6 py-lg-7">
      ...
      <div class="col-lg-5">
        <a href="/features/code-review" class="summarylink">
          ...
          <div class="summarylink-btn d-flex flex-justify-between flex-items-center f5 text-gray-dark rounded-1 p-sm-4 my-4 my-sm-0">
            ...
            <svg class="octicon octicon-triangle-right text-blue" viewBox="0 0 6 16" version="1.1" width="6" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M0 14l6-6-6-6v12z"></path></svg>
          </div>
        </a>
...
<div class="py-7 py-md-8 py-lg-9">
      ...
      <div class="communitystats position-relative">
        <a href="/open-source" class="d-inline-block summarylink">
          ...
          <div class="summarylink-btn d-flex flex-justify-between flex-items-center f5 text-gray-dark rounded-1 p-sm-4">
            ...
            <svg class="octicon octicon-triangle-right text-orange-light" viewBox="0 0 6 16" version="1.1" width="6" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M0 14l6-6-6-6v12z"></path></svg>
          </div>
        </a>
        ...
        <a href="/personal" class="d-inline-block summarylink">
          <div class="circle summary-circle d-flex flex-column flex-justify-center text-center p-4 mx-auto mt-6 mb-3 m-md-3 bg-blue box-shadow-extra-large">
            <span class="d-block h0-mktg text-normal text-white lh-condensed-ultra mb-1">50M<sup class="f2-light">*</sup></span>
        ...
        <a href="/business" class="d-inline-block summarylink">
          <div class="circle summary-circle d-flex flex-column flex-justify-center text-center p-4 mx-auto mt-6 mb-3 m-md-3 bg-purple box-shadow-extra-large">
            <span class="d-block h1-mktg text-normal text-white lh-condensed-ultra my-1">2.9M<sup class="f3-light">*</sup></span>
          ...
          <div class="summarylink-btn d-flex flex-justify-between flex-items-center f5 text-gray-dark rounded-1 p-sm-4">
            ...
            <svg class="octicon octicon-triangle-right text-purple" viewBox="0 0 6 16" version="1.1" width="6" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M0 14l6-6-6-6v12z"></path></svg>
          </div>
        </a>
  ...
  <div class="py-7 py-md-8 py-lg-9 bg-gray-dark">
    ...
    <div class="container-xl p-responsive py-6 mt-lg-6">
      <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="home-hero-signup js-signup-form" autocomplete="off" aria-label="Sign up" action="/join" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="YqonV1mIVBKkttUJslG56HeGaSKMTjTlhcM2BHgPsUs5JlURsfrbLdqpb92cHvVmnKhUgjcV60Rv8OWn5JSmdw==" />        <input type="hidden" name="ga_id" class="js-octo-ga-id-input">
        <div class="d-lg-flex flex-wrap flex-lg-nowrap flex-justify-between">
          <auto-check src="/signup_check/username" class="form-group col-12 col-sm-8 col-lg-3 mx-auto mt-0 mx-lg-0 mb-3 mb-lg-0 px-3">
            ...
            <input type="hidden" data-csrf="true" value="nnuZaTkI0ytTH3Wi4quGF7tQZ2fZAwhMbsDqzMpR964bx9VHTJ7lHVXoK6stWgSdcnMB2KnLm77LreVIxLAPNg==" />
          </auto-check>
          ...
          <auto-check src="/signup_check/email" class="form-group col-12 col-sm-8 col-lg-3 mx-auto mt-0 mx-lg-0 mb-3 mb-lg-0 px-3">
            ...
            <input type="hidden" data-csrf="true" value="VCQgJS3o4rG+DPyyZmIbE1QUu1y22K0DItxWd+/OjTyBO5Xa8DdoGn+xcRtgNvNx/iysf/6fK+7ABwAGJf6jZw==" />
          </auto-check>
          ...
          <input type="hidden" name="source" class="js-signup-source" value="form-home">
          <input class="form-control" type="text" name="required_field_69fc" hidden="hidden" />
<input class="form-control" type="hidden" name="timestamp" value="1588425151411" />
<input class="form-control" type="hidden" name="timestamp_secret" value="6229fc66ea1eaa0eacf302dee486a20487e5b7be713abece4415d357cd428de8" />
