...
<html lang="en">
  ...
  <meta name="request-id" content="60EC:414B:2B5EE2:4BDC5F:5EAD71B9" data-pjax-transient="true"/><meta name="html-safe-nonce" content="39dc7006cda34275b203d8b8e000285758fa28d4" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6IiIsInJlcXVlc3RfaWQiOiI2MEVDOjQxNEI6MkI1RUUyOjRCREM1Rjo1RUFENzFCOSIsInZpc2l0b3JfaWQiOiI5MTM1NTM4MTYxOTQzNjcxMjI1IiwicmVnaW9uX2VkZ2UiOiJpYWQiLCJyZWdpb25fcmVuZGVyIjoiaWFkIn0=" data-pjax-transient="true"/><meta name="visitor-hmac" content="e603255a9dc399da2d7ebacf1cf4bc60de6d6530390d16d2695d457747f8e21e" data-pjax-transient="true"/>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" role="search" aria-label="Site" data-unscoped-search-url="/search" action="/search" accept-charset="UTF-8" method="get">
      <label class="form-control input-sm header-search-wrapper p-0 header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          autocomplete="off"
          >
          <input type="hidden" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" value="ORj8IssyTs8FIUXhNBe9Mcpd7aMSzmSsxdEZMAaeXcOREig61844tg8xdbIT/2tl0SQtsaqtSOJFGFiT4wkJ5g==" />
...
<div class="py-6 py-sm-8 jumbotron-codelines">
  ...
  <div class="rounded-1 text-gray bg-gray-light py-4 px-4 px-md-3 px-lg-4">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="home-hero-signup text-gray-dark js-signup-form js-signup-form-submit" autocomplete="off" action="/join" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="12Wkhbr0ruDWfBpUNIpuVL4KKEi56om9Z2jrg/EjysvSZLQRiaNFtaiQelSq57zEJYXEePWVo8Oudv2Cg0gVJA==" />      <input type="hidden" name="ga_id" class="js-octo-ga-id-input">
      <auto-check src="/signup_check/username?source=homepage&amp;suggest_usernames=true">
        ...
        <input type="hidden" data-csrf="true" value="F6vaykAa5B7drLddfKK5RaNe9BWzExi7/8leuLzyS6q95aImRQeBdECluVu+5bohClZ044sQQN4Fq9xAioMkww==" />
      </auto-check>
      <auto-check src="/signup_check/email">
        ...
        <input type="hidden" data-csrf="true" value="XruOYnHcxB6W+IaVVRZisSkezoHmTlGlbDotY4KNe1TPgOoOxVSbpO3tJ30aO+seBh6J3Jgs5aotZfNX4ApzXQ==" />
      </auto-check>
      <password-strength
      ...
      <input class="form-control" type="text" name="required_field_4f6b" hidden="hidden" />
<input class="form-control" type="hidden" name="timestamp" value="1588425145876" />
<input class="form-control" type="hidden" name="timestamp_secret" value="b58c8167877123bd7eeb5e1f8b5c89d05b9f188cfe8f63ce34b0c120b6210849" />
...
<div class="py-7 py-md-8 py-lg-9">
  ...
  <div class="py-7 py-md-8 py-lg-9 bg-gray-dark">
    ...
    <div class="container-xl p-responsive py-6 mt-lg-6">
      <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="home-hero-signup js-signup-form" autocomplete="off" aria-label="Sign up" action="/join" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="JsmlG8TvWyIl5VJOuYBG+oFIA2XdlXv9KyHH41zVyL8jyLWP97iwd1sJMk4n7ZRqGsfvVZHqUYPiP9HiLr4XUA==" />        <input type="hidden" name="ga_id" class="js-octo-ga-id-input">
        <div class="d-lg-flex flex-wrap flex-lg-nowrap flex-justify-between">
          <auto-check src="/signup_check/username" class="form-group col-12 col-sm-8 col-lg-3 mx-auto mt-0 mx-lg-0 mb-3 mb-lg-0 px-3">
            ...
            <input type="hidden" data-csrf="true" value="R3Gi0ycN8buZblPuXZLocDJKOUNjZkUCeTPxNhhIV+7tP9o/IhCU0QRnXeif1esUm0K5tVtlHWeDUXPOLjk4hw==" />
          </auto-check>
          ...
          <auto-check src="/signup_check/email" class="form-group col-12 col-sm-8 col-lg-3 mx-auto mt-0 mx-lg-0 mb-3 mb-lg-0 px-3">
            ...
            <input type="hidden" data-csrf="true" value="wsHdv06k8pDOKMFil1MtpMwoifU5tpzQTjCJ+/wvOBtT+rnT+iytKrU9YIrYfqQL4yjOqEfUKN8Pb1fPnqgwEg==" />
          </auto-check>
          ...
          <input type="hidden" name="source" class="js-signup-source" value="form-home">
          <input class="form-control" type="text" name="required_field_1267" hidden="hidden" />
<input class="form-control" type="hidden" name="timestamp" value="1588425145878" />
<input class="form-control" type="hidden" name="timestamp_secret" value="e69c191536a7b9c2625d86272109a34a40bd38ea2ad6297e4d554014f4a88d7e" />
