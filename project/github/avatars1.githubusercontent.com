...
<html lang="en">
  ...
  <meta name="request-id" content="60DD:3839:88311E:C9B4CE:5EAD71B3" data-pjax-transient="true"/><meta name="html-safe-nonce" content="9005b41f9090a9d41c5c38fb4d2dc0d996daa13a" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6IiIsInJlcXVlc3RfaWQiOiI2MEREOjM4Mzk6ODgzMTFFOkM5QjRDRTo1RUFENzFCMyIsInZpc2l0b3JfaWQiOiI2MDIxMjA3NTE1MzM4NzMxOTU1IiwicmVnaW9uX2VkZ2UiOiJpYWQiLCJyZWdpb25fcmVuZGVyIjoiaWFkIn0=" data-pjax-transient="true"/><meta name="visitor-hmac" content="3ac760c9b377895fcc4bfef3cd859bb8e9d15df0ff74cd3d648e189a04380714" data-pjax-transient="true"/>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" role="search" aria-label="Site" data-unscoped-search-url="/search" action="/search" accept-charset="UTF-8" method="get">
      <label class="form-control input-sm header-search-wrapper p-0 header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          autocomplete="off"
          >
          <input type="hidden" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" value="bmTAyn3c6EAnhi6cqug++KI7abGLcRwmr/zuple6W5KVm7PUia0JOLDjVKx9Aa35aPxX81DJgZSgVZFnj+R4Mw==" />
...
<div class="py-6 py-sm-8 jumbotron-codelines">
  ...
  <div class="rounded-1 text-gray bg-gray-light py-4 px-4 px-md-3 px-lg-4">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="home-hero-signup text-gray-dark js-signup-form js-signup-form-submit" autocomplete="off" action="/join" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="COSCqKEwKKqSEaVTURN4ofOGLaN2Vo4ezsyVTL7GxzzdETiow3NooiJKlMDc1xR/FOKIsZ2E5OyPEzb9sOBvIw==" />      <input type="hidden" name="ga_id" class="js-octo-ga-id-input">
      <auto-check src="/signup_check/username?source=homepage&amp;suggest_usernames=true">
        ...
        <input type="hidden" data-csrf="true" value="W5TCbD0Uayo/FxXm11DsQe6VOPls+yhqJ+/lbKKHF2ADr7+ZgJUzgep7F2XFk6OvoNmKfmIO7WgTqB90yqfCRQ==" />
      </auto-check>
      <auto-check src="/signup_check/email">
        ...
        <input type="hidden" data-csrf="true" value="9SZwSZN/7DG0AoFISp0ektxtqXP6AfyzVZJMlRt8ck5mP5xTjohQCimk0xhG2FiOyv22aZWl8qyutd8TEkQHIA==" />
      </auto-check>
      <password-strength
      ...
      <input class="form-control" type="text" name="required_field_19bd" hidden="hidden" />
<input class="form-control" type="hidden" name="timestamp" value="1588425139987" />
<input class="form-control" type="hidden" name="timestamp_secret" value="d4fa495ee8fd264645f1b88714f0e23aae05f230d03d2bf635b91492bb1fc8ac" />
      ...
      <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="home-hero-signup js-signup-form" autocomplete="off" aria-label="Sign up" action="/join" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="X19SwGyk74FSmvmuUaWR6iI1S7ZOVORMIr4v62LR4biKqujADuevieLByD3cYf00xVHupKWGjr5jYYxabPdJpw==" />        <input type="hidden" name="ga_id" class="js-octo-ga-id-input">
        <div class="d-lg-flex flex-wrap flex-lg-nowrap flex-justify-between">
          <auto-check src="/signup_check/username" class="form-group col-12 col-sm-8 col-lg-3 mx-auto mt-0 mx-lg-0 mb-3 mb-lg-0 px-3">
            ...
            <input type="hidden" data-csrf="true" value="q7Fe5aRuNbSd0ghw4FNBktfYGrkEjIyxPNNFTy0C72nziiMQGe9tH0i+CvPykA58mZSoPgp5SbMIlL9XRSI6TA==" />
          </auto-check>
          ...
          <auto-check src="/signup_check/email" class="form-group col-12 col-sm-8 col-lg-3 mx-auto mt-0 mx-lg-0 mb-3 mb-lg-0 px-3">
            ...
            <input type="hidden" data-csrf="true" value="SezpCBrz2l9IX/CRHbdxllX/MvVbZUVrvEIeCpxtr9Pa9QUSBwRmZNX5osER8jeKQ28t7zTBS3RHZY2MlVXavQ==" />
          </auto-check>
          ...
          <input type="hidden" name="source" class="js-signup-source" value="form-home">
          <input class="form-control" type="text" name="required_field_10c6" hidden="hidden" />
<input class="form-control" type="hidden" name="timestamp" value="1588425139990" />
<input class="form-control" type="hidden" name="timestamp_secret" value="f4d783eb590de2a2bfd0ab14ead427aaf16824392ba9db9f4c9f75b849ddeed5" />
