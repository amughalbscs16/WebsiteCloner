...
<html lang="en">
  ...
  <meta name="request-id" content="60D2:6E31:5142BF:86C8A7:5EAD71AE" data-pjax-transient="true"/><meta name="html-safe-nonce" content="8733af24845c5518384760136c2565bfe00ff905" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6IiIsInJlcXVlc3RfaWQiOiI2MEQyOjZFMzE6NTE0MkJGOjg2QzhBNzo1RUFENzFBRSIsInZpc2l0b3JfaWQiOiIyMTQ5MDk0MDY0NzU1OTI5NTE4IiwicmVnaW9uX2VkZ2UiOiJpYWQiLCJyZWdpb25fcmVuZGVyIjoiaWFkIn0=" data-pjax-transient="true"/><meta name="visitor-hmac" content="fff536f8a36ab030ec8e31f19cc49a75790d6c2cce351d3f77e883e16c5f1a91" data-pjax-transient="true"/>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" role="search" aria-label="Site" data-unscoped-search-url="/search" action="/search" accept-charset="UTF-8" method="get">
      <label class="form-control input-sm header-search-wrapper p-0 header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          autocomplete="off"
          >
          <input type="hidden" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" value="YrKghyqfPGw3oxQHRtbbjBq4/nOLSnL2Ns1NEPNArZQKY8WCQP5bbPh40tcZP0qQ8wAHZZO2wvrBdl+4N9167Q==" />
  ...
  <div class="rounded-1 text-gray bg-gray-light py-4 px-4 px-md-3 px-lg-4">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="home-hero-signup text-gray-dark js-signup-form js-signup-form-submit" autocomplete="off" action="/join" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="JaaGeZmD8wIi3VEDkWBDs4vChUhyjRauLpC52LGa2q8PR2gSp0xX3JG05fp4JP9SlJgDAh5OH8gYy+Mda4Z50g==" />      <input type="hidden" name="ga_id" class="js-octo-ga-id-input">
      <auto-check src="/signup_check/username?source=homepage&amp;suggest_usernames=true">
        ...
        <input type="hidden" data-csrf="true" value="Exr8Q67VzWFyoDZSWsz583XibxPBsFZ/zYCsS20jpPUaWUBv6DdZEHH5pphlj1Ps/Q3sjfgjKPcTrIBrA9/whA==" />
      </auto-check>
      <auto-check src="/signup_check/email">
        ...
        <input type="hidden" data-csrf="true" value="Bg0uJPhNk6E2h+/LaIogRpwDrSyxKJ/bzLXxi/daOBObIlvpBPdHyN39MrGkAahQUDykgF1joYmeviZCUN+73g==" />
      </auto-check>
      <password-strength
      ...
      <input class="form-control" type="text" name="required_field_38bb" hidden="hidden" />
<input class="form-control" type="hidden" name="timestamp" value="1588425134955" />
<input class="form-control" type="hidden" name="timestamp_secret" value="7a88c03f799088ffa82f3950fec2e2ca005209bf6a7f5872e2d67e0ef0bf3f8d" />
...
<div class="py-7 py-md-8 py-lg-9">
  ...
  <div class="py-7 py-md-8 py-lg-9 bg-gray-dark">
    ...
    <div class="container-xl p-responsive py-6 mt-lg-6">
      <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="home-hero-signup js-signup-form" autocomplete="off" aria-label="Sign up" action="/join" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="VU6UxOu9tnSYueVRSt688V0mi+H2oNtyolJ0BRULXAF/r3qv1XISqivQUaijmgAQQnwNq5pj0hSUCS7Azxf/fA==" />        <input type="hidden" name="ga_id" class="js-octo-ga-id-input">
        <div class="d-lg-flex flex-wrap flex-lg-nowrap flex-justify-between">
          <auto-check src="/signup_check/username" class="form-group col-12 col-sm-8 col-lg-3 mx-auto mt-0 mx-lg-0 mb-3 mb-lg-0 px-3">
            ...
            <input type="hidden" data-csrf="true" value="amVMgliIS1/nhHeOQRBMFj47WlpYGFmeqBkCttNG9KRjJvCuHmrfLuTd50R+U+YJttTZxGGLJxZ2NS6Wvbqg1Q==" />
          </auto-check>
          ...
          <auto-check src="/signup_check/email" class="form-group col-12 col-sm-8 col-lg-3 mx-auto mt-0 mx-lg-0 mb-3 mb-lg-0 px-3">
            ...
            <input type="hidden" data-csrf="true" value="ObLMZxz75PyVBUXJsGfTtJZTTw0DSiliIIx8BxmTOpqknbmq4EEwlX5/mLN87FuiWmxGoe8BFzByh6vOvha5Vw==" />
          </auto-check>
          ...
          <input type="hidden" name="source" class="js-signup-source" value="form-home">
          <input class="form-control" type="text" name="required_field_3d7a" hidden="hidden" />
<input class="form-control" type="hidden" name="timestamp" value="1588425134958" />
<input class="form-control" type="hidden" name="timestamp_secret" value="b4cc01e902b9300528399262998de180279098f93c50298ad2ca5fbbd72edba7" />
